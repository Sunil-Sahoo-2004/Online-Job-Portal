      ...
      <?php foreach ($getApplicant as $jobApp): ?>
        <li style="widht:100px; height: 100px" class="d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
          <div class="job-listing-logo">
            ...
            <a style="text-decoration: none;" target="_blank" class=""
              href="<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $jobApp->job_id; ?>">
              <img style="widht:100px; height: 100px" src="user-images/<?php echo $_SESSION['image']; ?>"
          ...
          <div class="d-sm-flex custom-width w-100 justify-content-between mx-4">
            ...
            <div class="job-listing-meta">
              <a style="text-decoration: none;" target="_blank" class=""
                href="<?php echo APPURL; ?>/users/public-profile.php?id=<?php echo $jobApp->worker_id; ?>">
                <h5><?php echo $jobApp->email; ?></h5>
              </a>
            </div>

            <div class="job-listing-meta">
              <a class="btn btn-success text-white" href="<?php echo APPURL; ?>/users/user-cvs/<?php echo $jobApp->cv; ?>"
                role="button" download>Download CV</a>
            </div>
          </div>
