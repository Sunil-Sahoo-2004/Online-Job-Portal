  ...
  <div class="container">
    <div class="row align-items-center mb-5">
      <div class="col-lg-8 mb-4 mb-lg-0">
        <div class="d-flex align-items-center">
          <div class="border p-2 d-inline-block mr-3 rounded">
            <img style="width: 100px; height:100px; margin-bottom:10px"
              src="../users/user-images/<?php echo $row->company_image; ?>" alt="Image">
          </div>
          <div>
            <h2><?php echo $row->job_title; ?></h2>
            <div>
              <span class="ml-0 mr-2 mb-2"><span
                  class="icon-briefcase mr-2"></span><?php echo $row->company_name; ?></span>
              ...
              <span class="m-2"><span class="icon-clock-o mr-2"></span><span
                  class="text-primary"><?php echo $row->job_type; ?></span></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="mb-5">
            <figure class="mb-5"><img src="../images/job_single_img_1.jpg" alt="Image" class="img-fluid rounded">
            </figure>
          ...
          <div class="mb-5">
            ...
            <ul class="list-unstyled m-0 p-0">
              <li class="d-flex align-items-start mb-2"><span
                  class="icon-check_circle mr-2 text-muted"></span><span><?php echo $row->responsibilities; ?></span>
              </li>
          ...
          <div class="mb-5">
            ...
            <ul class="list-unstyled m-0 p-0">
              <li class="d-flex align-items-start mb-2"><span
                  class="icon-check_circle mr-2 text-muted"></span><span><?php echo $row->education_experience; ?></span>
              </li>
          ...
          <div class="mb-5">
            ...
            <ul class="list-unstyled m-0 p-0">
              <li class="d-flex align-items-start mb-2"><span
                  class="icon-check_circle mr-2 text-muted"></span><span><?php echo $row->other_benifits; ?></span></li>
            ...
            <?php if (isset($_SESSION['type']) and $_SESSION['type'] == "Worker"): ?>
              <div class="row">
                ...
                <?php if ($checking_for_saved_jobs->rowCount() == 0): ?>
                  <div class="col-md-6">
                    <a href="job-save.php?job_id=<?php echo $id; ?>&worker_id=<?php echo $_SESSION['id']; ?>&status=save"
                      class="btn btn-block btn-light btn-md"><i class="icon-heart"></i>Save Job</a>
                  </div>
                <?php else: ?>
                  <div class="col-md-6">
                    <a href="job-save.php?job_id=<?php echo $id; ?>&worker_id=<?php echo $_SESSION['id']; ?>&status=delete"
                      class="btn btn-block btn-light btn-md"><i class="icon-heart text-danger"></i>Saved Job</a>
                  </div>
                <?php endif; ?>
                ...
                <?php if ($checking_for_application->rowCount() == 0): ?>
                  ...
                  <form action="job-single.php?id=<?php echo $id; ?>" method="post">
                    ...
                    <div class="form-group">
                      <input type="hidden" name="email" value="<?php echo $_SESSION['email']; ?>" class="form-control" id=""
                        placeholder="email">
                    </div>
                    <div class="form-group">
                      <input type="hidden" name="cv" value="<?php echo $_SESSION['cv']; ?>" class="form-control" id=""
                        placeholder="cv">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="hidden" name="job_title" value="<?php echo $row->job_title; ?>" class="form-control" id=""
                        placeholder="job_title">
                    </div>

                    <div class="form-group">
                      <input type="hidden" name="company_id" value="<?php echo $row->company_id; ?>" class="form-control"
                        id="" placeholder="company_id">
                    </div>
                    <div class="col-6">
                      <button style="padding: 13px 157px; margin-top: -17px;" name="submit_application" type="submit"
                        class="btn btn-inline btn-primary btn-md">Apply</button>
                    </div>
                  </form>
          ...
          <?php if (isset($_SESSION['username'])): ?>
            <?php if (isset($_SESSION['type']) and $_SESSION['type'] == "Company"): ?>
              <?php if (isset($_SESSION['id']) and $_SESSION['id'] == $row->company_id): ?>
                <div class="row mb-5">
                  <div class="col-6">
                    <a href="<?php echo APPURL; ?>/jobs/job-update.php?id=<?php echo $row->id; ?>"
                      class="btn btn-block btn-light btn-md">Update</a>
                    <!--add text-danger to it to make it read-->
                  </div>
                  <div class="col-6">
                    <a style="margin-left: 300px" href="<?php echo APPURL; ?>/jobs/job-delete.php?id=<?php echo $row->id; ?>"
        ...
        <div class="col-lg-4">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              ...
              <li class="mb-2"><strong class="text-black">Application Deadline:</strong>
                <?php echo date('M', strtotime($row->application_deadline)) . ',' . date('d', strtotime($row->application_deadline)) . ' ' . date('Y', strtotime($row->application_deadline)); ?>
              </li>
              <li class="mb-2"><strong class="text-black">Job Category: </strong>
                <?php echo ucfirst($row->job_category); ?></li>
            </ul>
          </div>
          ...
          <div class="bg-light p-3 border rounded">
            ...
            <div class="px-3">
              <a href="https://www.facebook.com/sharer/sharer.php?u=https://localhost/jobboard/jobs/job-single.php?id=<?php echo $row->id; ?>&quote=<?php echo $row->job_title; ?>"
                class="pt-3 pb-3 pr-3 pl-0"><span class="icon-facebook"></span></a>
              <a href="https://twitter.com/intent/tweet?text=<?php echo $row->job_title; ?>&url=<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $row->id; ?>"
                class="pt-3 pb-3 pr-3 pl-0"><span class="icon-twitter"></span></a>
              <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo APPURL; ?>/jobs/job-single.php?id=<?php echo $row->id; ?>"
            ...
            <ul class="list-unstyled pl-3 mb-0">
              <?php foreach ($allCategories as $category): ?>
                <a target="_blank" style="text-decoration: none"
                  href="<?php echo APPURL; ?>/categories/show-jobs.php?name=<?php echo $category->name; ?>">
        ...
        <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
          ...
          <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
            ...
            <div class="job-listing-meta">
              <span
                class="badge badge-<?php if ($job->job_type == 'Part Time') {
                  echo 'danger';
                } else {
                  echo 'success';
